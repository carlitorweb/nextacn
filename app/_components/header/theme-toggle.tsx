...
const ThemeSwitch = () => {
  ...
  return (
    <button
      className='flex md:ml-4 h-6 w-6 items-center justify-center rounded-lg shadow-md shadow-black/5 ring-1 ring-black/5 dark:bg-slate-700 dark:ring-inset dark:ring-white/5'
      ...
      {theme === 'light' ? (
        ...
        <svg aria-hidden='true' viewBox='0 0 16 16' className='h-4 w-4 fill-sky-400'>
          <path
            fillRule='evenodd'
            clipRule='evenodd'
